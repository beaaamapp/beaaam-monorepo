<script lang="ts">
  ...
  import ArrowUp from '$lib/static/icons/ArrowUp.svelte';
  import Plus from '$lib/static/icons/Plus.svelte';
  import Minus from '$lib/static/icons/Minus.svelte';
  ...
  async function checkUrlUserId() {
    ...
    const connectedToRightUser = checkIsUser(decodedUrlUserId.beamsUserId);
