...
<script lang="ts">
  ...
  import CheckCircleIcon from '$lib/static/icons/CheckCircle.svelte';
  import ExclamationCircleIcon from '$lib/static/icons/ExclamationCircle.svelte';

  import KeyHint from '$lib/static/icons/KeyHint.svelte';
  import Spinner from '$lib/static/icons/Spinner.svelte';
