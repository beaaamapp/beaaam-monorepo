...
<StepLayout>
  <StepHeader
    ...
    description="Warning: You’re about to add a token which is not officially-supported by the Beams app. If this token is not fully compliant with the ERC-20 token standard, any deposited tokens <b class='typo-text-bold'>may be unrecoverable</b>."
  />
